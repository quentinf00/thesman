...
\begin{figure*}[!t]%
   \centering
   \makebox[\textwidth]{
    \subfloat[$f$]{{\includegraphics[width=.7\textwidth,clip,trim=0.5cm 0 2cm 1cm]{00_Calib/swath_err_details} }}%
    \subfloat[$\mathcal{G}_{200km}(f) - \mathcal{G}_{10km}(f)$]{{\includegraphics[width=.7\textwidth,clip,trim=0.5cm 0 2cm 1cm]{00_Calib/swath_err_f10_200_details} }}}%
...
\begin{figure*}
    \begin{center}
        \makebox[\textwidth]{
	    \includegraphics[width=1.3\textwidth]{00_Calib/CalDiag2.png}}
    \end{center}
