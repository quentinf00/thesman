...
\logoecoledoc{./Couverture-these/SPIN/logo_spin} %logo ecole doctorale
\logoetablissement{./Couverture-these/MathSTIC/logo-etablissements/logo_IMT_Atlantique}%logo etablissement (ici Rennes 1) 
\vspace{2.5cm}
%Indiquer l'\'{e}tablissement de d\'{e}livrance du diplome
%Provide the name of the institution that delivers the diploma, 
\unite{l’\'{E}cole Nationale Supérieure 
...
\AddToShipoutPicture*{%
    ...
    \parbox[b][42.5cm]{\paperwidth}{%
        \vfill
        \includegraphics[width=\paperwidth,keepaspectratio]{./Couverture-these/SPIN/spin_garde.png}% image de fond UR1
        \vfill
}}}
...
\footnotesize
\begin{tabular}{@{}ll}
Claire Monteleoni & Professeure Université Boulder Colorado \\
...
Pr\'{e}sident :        & (TBD) Fran\c ois ROUSSEAU & Professeur, IMT Atlantique \\
Examinateurs :         & Marc Bocquet & Professeur, École des Ponts ParisTech \\
                       & Florence  Tupin & Professeure, Telecom Paris \\
                       & Gérald Dibarboure & CNES \\
                       % & Pr\'{e}nom Nom & Fonction et \'{e}tablissement d'exercice \\
                       % & Pr\'{e}nom Nom & Fonction et \'{e}tablissement d'exercice \\
Dir. de th\`{e}se :    & Ronan Fablet & Professeur, IMT Atlantique \\
Co-dir. de th\`{e}se : & Julien Le Sommer & Docteur, Université Grenoble-Alpes \\
& Cl\'{e}ment Ubelmann & Docteur Datlas \\
\end{tabular}
