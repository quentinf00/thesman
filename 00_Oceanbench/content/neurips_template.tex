\section{Submissions to the NeurIPS 2023 Track on Datasets and Benchmarks}
...
\begin{center}
  \url{http://www.neurips.cc/Conferences/2023/CallForDatasetsBenchmarks}
\end{center}
The file \verb+neurips_data_2023.pdf+ contains these instructions and illustrates the
various formatting requirements your submission must satisfy.

The only supported style file for NeurIPS 2023 is \verb+neurips_data_2023.sty+,
